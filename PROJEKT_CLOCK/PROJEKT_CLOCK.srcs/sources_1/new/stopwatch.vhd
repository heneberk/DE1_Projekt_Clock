...
entity stopwatch is
    Port (
        ...
        btn_center   : in  STD_LOGIC;                        -- tla?ítko pro ovládání režimu
        seg_display  : out STD_LOGIC_VECTOR(23 downto 0)     -- výstup pro 6 ?íslic
    );
end stopwatch;
...
architecture Behavioral of stopwatch is
    ...
    signal btn_state    : INTEGER range 0 to 2 := 0;     -- 0 = ?ekání, 1 = bíží, 2 = zastaveno
    signal running      : STD_LOGIC := '0';
    signal blinking     : STD_LOGIC := '0';
    signal btn_reg      : STD_LOGIC := '0';              -- pro zachycení nábážné hrany tla?ítka
...
begin
    ...
    -- ?ízení režimu pomocí BTN_CENTER
    process(clk)
